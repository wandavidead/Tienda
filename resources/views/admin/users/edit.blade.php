                ...
                <div class="row">
                    ...
                    <x-adminlte-select2 name="impuesto_id" label="Impuestos" fgroup-class="col-md-4"
                        ...
                        @foreach ($impuestos as $impuesto)
                            <option value="{{ $impuesto->id }}" @if ($impuesto->id == $producto->impuesto->id) selected @endif>
                    ...
                    <x-adminlte-select2 name="proveedor_id" label="Proveedor" fgroup-class="col-md-4"
                        ...
                        @foreach ($proveedores as $proveedor)
                            <option value="{{ $proveedor->id }}" @if ($proveedor->id == $producto->proveedor->id) selected @endif>

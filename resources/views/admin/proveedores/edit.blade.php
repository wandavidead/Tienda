    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('proveedores.update', $proveedore) }}" method="post">
                ...
                @method('put')
                <div class="row">
                    {{-- input de nombre de proveedore con select2 --}}
                    <x-adminlte-input name="nombre_Fiscal" label="Nombre Fiscal" placeholder="Nombre Fiscal"
                        ...
                        value=" {{ $proveedore->nombre_Fiscal }}">
                    ...
                    {{-- input de codigo postal de proveedore con select2 --}}
                    ...
                    {{-- input de direccion de proveedore con select2 --}}
                ...
                <div class="row">
                    ...
                    <x-adminlte-input type="number" min="0" name="codigo_postal" label="Codigo Postal"
                        ...
                        value=" {{ $proveedore->codigo_postal }}">
                    </x-adminlte-input>
                    {{-- input de provincia de proveedore con select2 --}}
                    ...
                    {{-- input de municipio de proveedore con select2 --}}
                    <x-adminlte-input name="municipio" label="Municipio" placeholder="Municipio"
                        label-class="text-lightblue" fgroup-class="col-md-3" type="text"
                        value=" {{ $proveedore->municipio }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                                <i class="fas fa-user text-lightblue"></i>
                            </div>

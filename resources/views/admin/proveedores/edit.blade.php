...
<div>
    ...
    <form action="{{ route('proveedores.update', $proveedor) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input name="nombre_Fiscal" placeholder="Nombre Fiscal"
                                    label-class="text-lightblue" fgroup-class="col-md-12" type="text" value=" {{ $proveedor->nombre_Fiscal }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input name="cif" placeholder="CIF" label-class="text-lightblue"
                                    fgroup-class="col-md-12" type="text" value="{{ $proveedor->cif }}">
                                    <x-slot name="prependSlot">
                                        <div class="input-group-text">
                                            <i class="fas fa-user text-lightblue"></i>
                                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input name="direccion" placeholder="Dirección" label-class="text-lightblue"
                                    fgroup-class="col-md-12" type="text" value=" {{ $proveedor->direccion }}">
                                    <x-slot name="prependSlot">
                                        <div class="input-group-text">
                                            <i class="fas fa-user text-lightblue"></i>
                                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input type="number" min="0" name="codigo_postal"
                                    ...
                                    fgroup-class="col-md-12" value=" {{ $proveedor->codigo_postal }}">
                                </x-adminlte-input>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input name="provincia" placeholder="Provincia" label-class="text-lightblue"
                                    fgroup-class="col-md-12" type="text" value=" {{ $proveedor->provincia }}">
                                    <x-slot name="prependSlot">
                                        <div class="input-group-text">
                                            <i class="fas fa-user text-lightblue"></i>
                                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-adminlte-input name="municipio" placeholder="Municipio" label-class="text-lightblue"
                                    fgroup-class="col-md-12" type="text" value=" {{ $proveedor->municipio }}">
                                    <x-slot name="prependSlot">
                                        <div class="input-group-text">
                                            <i class="fas fa-user text-lightblue"></i>
                                        </div>
        ...
        {{-- Parte final botones aceptar y cancelar --}}
        <div class="form-group row">
            <div class="col">
                <div class="card">
